...
export default function Footer() {
  return (
    <footer className="bg-black/80 backdrop-blur-sm border-t border-white/10 py-6 sm:py-8 px-4 sm:px-6 overflow-x-hidden w-full max-w-full">
      <div className="container mx-auto text-center w-full">
        ...
        >
          ...
          <motion.h3
            className="text-xl sm:text-2xl font-bold text-white mb-2 px-2"
